...
const Icons = {
  cloud: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M18.5 19H7C4.79086 19 3 17.2091 3 15C3 12.7909 4.79086 11 7 11C7 7.68629 9.68629 5 13 5C16.3137 5 19 7.68629 19 11C20.6569 11 22 12.3431 22 14C22 15.6569 20.6569 17 19 17H18.5V19Z" 
            fill="url(#cloudGrad)" stroke="url(#cloudGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  folder: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M3 7C3 5.89543 3.89543 5 5 5H9L11 7H19C20.1046 7 21 7.89543 21 9V17C21 18.1046 20.1046 19 19 19H5C3.89543 19 3 18.1046 3 17V7Z" 
            fill="url(#folderGrad)" stroke="url(#folderGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  file: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z" 
            fill="url(#fileGrad)" stroke="url(#fileGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  server: () => (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="2" y="2" width="20" height="6" rx="2" fill="url(#serverGrad)" stroke="url(#serverGrad)" strokeWidth="2"/>
      <rect x="2" y="10" width="20" height="6" rx="2" fill="url(#serverGrad)" stroke="url(#serverGrad)" strokeWidth="2"/>
      <rect x="2" y="18" width="20" height="4" rx="2" fill="url(#serverGrad)" stroke="url(#serverGrad)" strokeWidth="2"/>
  ...
  share: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="18" cy="5" r="3" fill="url(#shareGrad)" stroke="url(#shareGrad)" strokeWidth="2"/>
      <circle cx="6" cy="12" r="3" fill="url(#shareGrad)" stroke="url(#shareGrad)" strokeWidth="2"/>
      <circle cx="18" cy="19" r="3" fill="url(#shareGrad)" stroke="url(#shareGrad)" strokeWidth="2"/>
      <path d="M8.59 13.51L15.42 17.49M15.41 6.51L8.59 10.49" stroke="url(#shareGrad)" strokeWidth="2"/>
    </svg>
  ),
  lock: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="5" y="11" width="14" height="10" rx="2" fill="url(#lockGrad)" stroke="url(#lockGrad)" strokeWidth="2"/>
  ...
  upload: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M21 15V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V15" 
            stroke="url(#uploadGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M17 8L12 3L7 8" stroke="url(#uploadGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M12 3V15" stroke="url(#uploadGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  notion: () => (
    <svg
